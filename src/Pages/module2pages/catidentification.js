...
function Module2_catidentification () {

  return (
    <div>
        <p>
        Our AI identified it as a Egyptian Cat. 
        </p>
        <p>
      ...
      <div>
         <button onClick={ () =>  window.location.href='/module2-catlayers'}> Continue </button>
      </div>
...
export default Module2_catidentification;