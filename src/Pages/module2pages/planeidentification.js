...
function Module2_planeidentification () {

  return (
    <div>
        <p>
        Our AI identified it as a Wing. 
        </p>
        <p>
      ...
      <div>
         <button onClick={ () =>  window.location.href='/module2-planelayers'}> Continue </button>
      </div>
...
export default Module2_planeidentification;